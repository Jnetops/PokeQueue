...
class GroupInviteSend extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        ...
        if ($this->checkGroup->type == 1)
        {
          $typeArray['type'] = 'Gym Battles: ';
          if ($this->checkGroup->subType1 == 1)
          {
            $typeArray['subType1'] = 'Valor';
          }
          elseif ($this->checkGroup->subType1 == 2)
          {
        ...
        elseif ($this->checkGroup->type == 2)
        {
          ...
          elseif ($this->checkGroup->subType1 == 2)
          {
            ...
            {
              if ($pokemonValue == $this->checkGroup->subType2)
              {
        ...
        $groupInvite = [
          'group' => [
            ...
            'statement' => ' Has invited you to join a group for ',
            'types' => $typeArray,
